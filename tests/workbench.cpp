...
*/
DEF(dfl_forward)(model_ref m, span<tensor> input, param_dict const& p) {
...
// Call the C++ make_anchors implementation.
// NOTE: the DEF(...) macro declares the prototype as
//   std::vector<tensor> _test_func_make_anchors(model_ref, std::span<tensor>, param_dict const&)
