...
cd scripts
uv run ./scripts/convert.py --arch yolov9t --input ./scripts/yolov9t_converted.pth --model-name yolov9t --output ./models/yolov9t_converted.gguf --layout whcn --verbose
