                    ...
                    if target_suffix == source_suffix:
                        ...
                        try:
                            if (
                                ...
                                == source_state_dict[source_key].shape
                            ):
                                return source_key
                        except:
                            pass
        ...
        for target_key in target_state_dict.keys():
            ...
            if source_key:
                ...
                if target_state_dict[target_key].shape == source_state_dict[source_key].shape:
                    ...
                    print(
                        f"Shape mismatch: {target_key} {target_state_dict[target_key].shape} != {source_key} {source_state_dict[source_key].shape}"
                    )
...
def load_yolov9t():
    ...
    YOLO('yolov9t.pt')  # Ensure model is downloaded
